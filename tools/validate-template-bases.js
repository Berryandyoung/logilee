...
const expected = {
  ...
  "pro-forma-invoice.xlsx": ["PRO FORMA INVOICE", "1.Shipper / Exporter", "13.Description of Goods", "TOTAL AMOUNT :"],
...
(async () => {
  ...
  for (const [fileName, anchors] of Object.entries(expected)) {
    ...
    try {
      ...
      if (fileName !== "shipment-checklist.xlsx" && sheet.getRow(23).getCell(1).border.bottom.style === undefined) errors.push(`${fileName}: item style area missing`);
