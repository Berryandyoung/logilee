...
- `CONTEXTUAL_LINKING_WEAK` — `en/posts/canada-us-counter-tariffs-september-2026/index.html`: No contextual internal link found in article body.
- `CONTEXTUAL_LINKING_WEAK` — `en/posts/cbm-calculation/index.html`: No contextual internal link found in article body.
...
- `CONTEXTUAL_LINKING_WEAK` — `en/posts/eu-customs-reform-small-parcel-fee-overhaul-2026/index.html`: No contextual internal link found in article body.
- `CONTEXTUAL_LINKING_WEAK` — `en/posts/eu-deforestation-regulation-eudr-guide-2026/index.html`: No contextual internal link found in article body.
- `CONTEXTUAL_LINKING_WEAK` — `en/posts/fob-vs-cif/index.html`: No contextual internal link found in article body.
- `CONTEXTUAL_LINKING_WEAK` — `en/posts/hormuz-red-sea-shipping-risk-august-2026/index.html`: No contextual internal link found in article body.
- `CONTEXTUAL_LINKING_WEAK` — `en/posts/hs-code-search/index.html`: No contextual internal link found in article body.
- `CONTEXTUAL_LINKING_WEAK` — `en/posts/lcl-vs-fcl/index.html`: No contextual internal link found in article body.
...
- `CONTEXTUAL_LINKING_WEAK` — `ko/posts/hormuz-red-sea-shipping-risk-august-2026/index.html`: No contextual internal link found in article body.
- `CONTEXTUAL_LINKING_WEAK` — `ko/posts/hs-code-search/index.html`: No contextual internal link found in article body.
- `CONTEXTUAL_LINKING_WEAK` — `ko/posts/hs-code-vs-hts-code-us-export/index.html`: No contextual internal link found in article body.
- `CONTEXTUAL_LINKING_WEAK` — `ko/posts/hs-customs-value-freight-insurance-incoterms-guide/index.html`: No contextual internal link found in article body.
- `CONTEXTUAL_LINKING_WEAK` — `ko/posts/kita-trade-promotion-fund-september-2026/index.html`: No contextual internal link found in article body.
- `CONTEXTUAL_LINKING_WEAK` — `ko/posts/korea-exports-august-2026-semiconductor/index.html`: No contextual internal link found in article body.
...
| URL | Status | Canonical | Hreflang | Sitemap | Internal links | Indexability | Proposed action |
|---|---|---|---|---:|---:|---|---|
| /about.html | EXISTS | https://www.logilee.com/about.html | — | yes | 5 | INDEXABLE | REVIEW; preserve URL pending editorial/CMS decision |
| /ko/about.html | EXISTS | https://www.logilee.com/ko/about.html | — | no | 1 | INDEXABLE | REVIEW; preserve URL pending editorial/CMS decision |
| /en/about.html | EXISTS | https://www.logilee.com/en/about.html | — | no | 1 | INDEXABLE | REVIEW; preserve URL pending editorial/CMS decision |
| /privacy-policy.html | EXISTS | https://www.logilee.com/privacy-policy.html | ko, en, x-default | yes | 3 | INDEXABLE | REVIEW; preserve URL pending editorial/CMS decision |
| /privacy-policy-en.html | EXISTS | https://www.logilee.com/privacy-policy-en.html | ko, en, x-default | yes | 4 | INDEXABLE | REVIEW; preserve URL pending editorial/CMS decision |
| /terms.html | EXISTS | https://www.logilee.com/terms.html | ko, en, x-default | yes | 3 | INDEXABLE | REVIEW; preserve URL pending editorial/CMS decision |
| /terms-en.html | EXISTS | https://www.logilee.com/terms-en.html | ko, en, x-default | yes | 4 | INDEXABLE | REVIEW; preserve URL pending editorial/CMS decision |
| /ko/privacy-policy.html | MISSING | — | — | no | 0 | N/A | REVIEW; preserve URL pending editorial/CMS decision |
| /en/privacy-policy.html | MISSING | — | — | no | 0 | N/A | REVIEW; preserve URL pending editorial/CMS decision |
| /ko/terms.html | MISSING | — | — | no | 0 | N/A | REVIEW; preserve URL pending editorial/CMS decision |
| /en/terms.html | MISSING | — | — | no | 0 | N/A | REVIEW; preserve URL pending editorial/CMS decision |
